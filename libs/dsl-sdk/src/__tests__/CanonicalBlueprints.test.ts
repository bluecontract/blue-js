...
const CANONICAL_BLUEPRINTS_TIMEOUT_MS = Number(
  process.env.BLUE_CANONICAL_BLUEPRINTS_TIMEOUT_MS ?? 30_000,
);

describe('canonical blueprints', () => {
  it(
    'keep exported sample documents structurally stable and editable',
    () => {
    ...
    CANONICAL_BLUEPRINTS_TIMEOUT_MS,
  );
});
