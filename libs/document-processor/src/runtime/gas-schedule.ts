 ...
 * - `return 1;` ≈ 2.4M fuel → ~15 host gas
 * - 1,000-iteration loop ≈ 53M fuel → ~328 host gas
 * - 10,000-iteration loop ≈ 487M fuel → ~3,006 host gas
 *
 * Adjust this value when recalibrating the gas schedule after QuickJS or
 * Emscripten upgrades. See `config/gas-schedule.md` for full documentation.
 */
